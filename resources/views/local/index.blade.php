...
<script>
    ...
    var ImportLocal   = "{{url('importLocal')}}";
</script>
<div class="content-page">
    <div class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <button class="btn btn-success" style="margin-right: 5px" data-bs-toggle="modal" data-bs-target="#ModalImportLocal">
                                    <i class="fa-solid fa-file-import"></i> Importer des locaux
                                </button>
                                @endcan
                            </div>
        ...
        <!-- Modal Importer des Locaux -->
        <div class="modal fade" id="ModalImportLocal" tabindex="-1" aria-labelledby="ModalImportLocalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ModalImportLocalLabel">Importer des locaux</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <ul class="validationImportLocal"></ul>
                            <form action="{{ url('importLocal') }}" id="FormImportLocal" enctype="multipart/form-data">
                                <!-- Fichier -->
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <div class="alert alert-info">
                                            <p><strong>Note:</strong> Le fichier Excel doit contenir une colonne "nom" avec les noms des locaux.</p>
                    ...
                    <div class="modal-footer text-end">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                        <button type="button" class="btn btn-success" id="BtnImportLocal">Importer</button>
                    </div>
                </div>
            </div>
        </div>
