...
<script>
    ...
    var ImportSubCategory         = "{{url('importSubCategory')}}";
</script>
<div class="content-page">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="mb-3">
                                ...
                                <button class="btn btn-success" style="margin-right: 5px" data-bs-toggle="modal" data-bs-target="#ModalImportSubCategory">
                                    <i class="fa-solid fa-file-import"></i> Importer des familles
                                </button>
                                @endcan
                            </div>
    ...
    @can('Famille-ajoute')
<!-- Modal Importer des Familles -->
<div class="modal fade" id="ModalImportSubCategory" tabindex="-1" aria-labelledby="ModalImportSubCategoryLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalImportSubCategoryLabel">Importer des familles</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <ul class="validationImportSubCategory"></ul>
                    <form action="{{ url('importSubCategory') }}" id="FormImportSubCategory" enctype="multipart/form-data">
                        <!-- Fichier -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    ...
                                    <p>- Une colonne "nom" avec les noms des familles</p>
                                    <p>- Une colonne "categorie" avec les noms des catégories existantes</p>
                                    <p>Les doublons, les catégories inexistantes et les lignes vides seront ignorés automatiquement.</p>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="modal-footer text-end">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                <button type="button" class="btn btn-success" id="BtnImportSubCategory">Importer</button>
            </div>
        </div>
    </div>
</div>
