...
<body>
            ...
            <div class="container ">
                ...
                <table id="tableDetail">
                    ...
                    <tr>
                        ...
                        <th  >
                            Date : {{ \Carbon\Carbon::parse($Data_Achat[0]->created_at)->format('d/m/Y') }}
                        </th>
                    </tr>
                </table>
                ...
                <table id="tableDetail" style="margin-top: 30px">
                    <thead>
                        <tr>
                            ...
                            <td style="text-align: center"><strong>Quantité Quantité </strong></td>
    ...
    <tbody>
        <tr>
            <td style="text-align: center; border: 1px solid black; height: 100px; vertical-align: top; padding: 10px;">&nbsp;</td>
            <td style="text-align: center; border: 1px solid black; height: 100px; vertical-align: top; padding: 10px;">&nbsp;</td>
            <td style="text-align: center; border: 1px solid black; height: 100px; vertical-align: top; padding: 10px;">&nbsp;</td>
            <td style="text-align: center; border: 1px solid black; height: 100px; vertical-align: top; padding: 10px;">&nbsp;</td>
        </tr>
