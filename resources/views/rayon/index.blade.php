...
<script>
    ...
    var ImportRayon   = "{{url('importRayon')}}";
</script>
<div class="content-page">
    <div class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <button class="btn btn-success" style="margin-right: 5px" data-bs-toggle="modal" data-bs-target="#ModalImportRayon">
                                    <i class="fa-solid fa-file-import"></i> Importer des rayons
                                </button>
                                @endcan
                            </div>
     ...
     <!-- Import Rayon Modal -->
<div class="modal fade" id="ModalImportRayon" tabindex="-1" aria-labelledby="ModalImportRayonLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalImportRayonLabel">Importer des rayons</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <ul class="validationImportRayon"></ul>
                    <form action="{{ url('importRayon') }}" id="FormImportRayon" enctype="multipart/form-data">
                        <!-- Fichier -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    <p><strong>Format requis:</strong> Le fichier Excel doit contenir:</p>
                                    <ul>
                                        <li>Une colonne <strong>"nom"</strong> avec les noms des rayons</li>
                                        <li>Une colonne <strong>"local"</strong> avec les noms des locaux où créer les rayons</li>
                                    </ul>
                                    <p>Les rayons seront créés dans les locaux correspondants. Si un local n'existe pas, la ligne sera ignorée.</p>
            ...
            <div class="modal-footer text-end">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                <button type="button" class="btn btn-success" id="BtnImportRayon">Importer</button>
            </div>
        </div>
    </div>
</div>
