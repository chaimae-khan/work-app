...
<script>
    ...
    var ImportUnite       = "{{url('importUnite')}}";
</script>
<div class="content-page">
    ...
    <button class="btn btn-success" style="margin-right: 5px" data-bs-toggle="modal" data-bs-target="#ModalImportUnite">
        <i class="fa-solid fa-file-import"></i> Importer des unités
    </button>
    @endcan
</div>
    ...
    @can('Unité-ajoute')
<!-- Modal Importer des Unités -->
<div class="modal fade" id="ModalImportUnite" tabindex="-1" aria-labelledby="ModalImportUniteLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalImportUniteLabel">Importer des unités</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <ul class="validationImportUnite"></ul>
                    <form action="{{ url('importUnite') }}" id="FormImportUnite" enctype="multipart/form-data">
                        <!-- Fichier -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    <p><strong>Note:</strong> Le fichier Excel doit contenir une colonne "nom" avec les noms des unités.</p>
            ...
            <div class="modal-footer text-end">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                <button type="button" class="btn btn-success" id="BtnImportUnite">Importer</button>
            </div>
        </div>
    </div>
</div>
