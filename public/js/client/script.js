$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function(fonctions) {
            let $addSelect = $('#Fonction');
            let $editSelect = $('#EditFonction');
            ...
            // Add default option
            $addSelect.append('<option value="">Sélectionner une fonction</option>');
            $editSelect.append('<option value="">Sélectionner une fonction</option>');
            
            // Populate options
            fonctions.forEach(function(fonction) {
                $addSelect.append(`<option value="${fonction}">${fonction}</option>`);
                $editSelect.append(`<option value="${fonction}">${fonction}</option>`);
            });
        },
        error: function() {
            console.error('Erreur lors du chargement des fonctions');
        }
    });
            ...
            $(selector + ' tbody').on('click', '.editClient', function(e)
            {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#EditFonction').val(response.Fonction || '');
